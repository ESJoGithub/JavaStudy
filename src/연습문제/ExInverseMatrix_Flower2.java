...
public class ExInverseMatrix_Flower2 {
	...
	public static void main(String[] args) {
		...
		System.out.println();
		System.out.printf("%2.2f\t%2.2f\t%2.2f\t%n", coef[0],coef[1],coef[2]);
		System.out.printf("%2.2f\t%2.2f\t%2.2f\t%n", coef[4],coef[5],coef[6]);
		System.out.printf("%2.2f\t%2.2f\t%2.2f\t%n", coef[8],coef[9],coef[10]);
		System.out.println();
		System.out.printf("x=%2.2f y=%2.2f z=%2.2f입니다.", coef[3], coef[7], coef[11]);
		scan.close();
	}
}